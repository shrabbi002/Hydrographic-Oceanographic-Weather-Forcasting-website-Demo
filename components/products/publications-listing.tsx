...
import { BookOpen, Download, Eye, Lightbulb, Compass, Radio, Ship, Calendar } from "lucide-react"
...
const categoryInfo: Record<string, { label: string; icon: React.ElementType; description: string }> = {
  list_of_lights: {
            ...
            <CardContent className="p-0">
              <div className="divide-y">
                {publications.map((pub) => (
                  <div key={pub.id} className="flex items-center justify-between p-4">
                    <div>
